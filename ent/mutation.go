...
func (m *TodoMutation) ClearAuthor() {
	m.clearedauthor = true
}

// AuthorCleared reports if the "author" edge to the User entity was cleared.
func (m *TodoMutation) AuthorCleared() bool {
...
func (m *TodoMutation) ResetAuthor() {
	m.author = nil
...
func (m *TodoMutation) AddedEdges() []string {
	...
	if m.author != nil {
		edges = append(edges, todo.EdgeAuthor)
	}
	return edges
}
