...
func (tc *TodoCreate) SetAuthorID(id uuid.UUID) *TodoCreate {
	tc.mutation.SetAuthorID(id)
	return tc
}

// SetAuthor sets the "author" edge to the User entity.
func (tc *TodoCreate) SetAuthor(u *User) *TodoCreate {
...
func (tc *TodoCreate) check() error {
	...
	if len(tc.mutation.AuthorIDs()) == 0 {
		return &ValidationError{Name: "author", err: errors.New(`ent: missing required edge "Todo.author"`)}
	}
	return nil
}
