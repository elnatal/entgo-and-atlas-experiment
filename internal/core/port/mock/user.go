...
import (
	...
	domain "github.com/elnatal/go-experiment/internal/core/domain"
...
func (m *MockUserRepository) ListUsers(ctx context.Context, skip, limit int) ([]domain.User, error) {
	m.ctrl.T.Helper()
...
// ListUsers mocks base method.
func (m *MockUserService) ListUsers(ctx context.Context, skip, limit int) ([]domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListUsers", ctx, skip, limit)
	ret0, _ := ret[0].([]domain.User)
	ret1, _ := ret[1].(error)
...
// ListUsers indicates an expected call of ListUsers.
func (mr *MockUserServiceMockRecorder) ListUsers(ctx, skip, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
